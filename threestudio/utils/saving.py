...
class SaverMixin:
    ...
    def save_image_grid(
        ...
        if_normal: bool = False,
        if_only_img: bool = False
    ):
        save_path = self.get_save_path(filename)
        if if_only_img:
            save_path = os.path.join(self.get_save_dir(), 'only_img')
            os.makedirs(save_path, exist_ok=True)
            save_path = os.path.join(save_path, filename)
            os.makedirs(os.path.dirname(save_path), exist_ok=True)
        if if_normal:
            save_path = os.path.join(self.get_save_dir(), 'normal')
            os.makedirs(save_path, exist_ok=True)
            save_path = os.path.join(save_path, filename)
            os.makedirs(os.path.dirname(save_path), exist_ok=True)
    ...
    def save_img_sequence(
        ...
        if if_only_img:
            save_path = os.path.join(self.get_save_dir(), 'only_img_video', filename)
            os.makedirs(os.path.dirname(save_path), exist_ok=True)
            img_dir = os.path.join(self.get_save_dir(), 'only_img', img_dir)

        elif if_normal:
            save_path = os.path.join(self.get_save_dir(), 'normal_video', filename)
            os.makedirs(os.path.dirname(save_path), exist_ok=True)
            img_dir = os.path.join(self.get_save_dir(), 'normal', img_dir)
