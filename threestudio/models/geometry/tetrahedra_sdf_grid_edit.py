...
@threestudio.register("tetrahedra-sdf-grid-edit")
class TetrahedraSDFGrid(BaseExplicitGeometry):
    ...
    class Config(BaseExplicitGeometry.Config):
        ...
        use_sdf_deformation: bool = False
    ...
    def configure(self) -> None:
        ...
        if self.cfg.use_sdf_deformation is True:
            self.register_parameter(
                "deformation_sdf",
                nn.Parameter(
                    torch.zeros(
    ...
    def isosurface(self) -> Mesh:
        ...
        if self.cfg.use_sdf_deformation is True:
            ...
            mesh = self.isosurface_helper(self.sdf + self.deformation_sdf, self.deformation_face)
        else:
            mesh = self.isosurface_helper(self.sdf, self.deformation_face)
