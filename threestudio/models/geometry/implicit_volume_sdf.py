...
@threestudio.register("implicit-volume-sdf")
class ImplicitVolumeSDF(BaseImplicitGeometry):
    @dataclass
    ...
    def initialize_shape(self) -> None:
        ...
        for _ in tqdm(
            ...
            density_pred = self.forward_raw_density(points_rand)
            loss = F.mse_loss(density_pred, volsdf_density(sdf_gt ))
            optim.zero_grad()
            loss.backward()
            optim.step()
    ...
    def forward_raw_density(self, points: Float[Tensor, "*N Di"]) -> Float[Tensor, "*N 1"]:
        ...
        density, _ = self.get_activated_density(points_unscaled, density)
        return density
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, ImplicitVolumeSDF):
            instance = ImplicitVolumeSDF(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {ImplicitVolumeSDF.__name__} from {other.__class__.__name__}"
            )
